...
public class UserServiceTest {
	...
	/**
	 * Before each testcase setup() is called,
	 * It will inject all mock into injectMocks
	 */
	@BeforeEach
	public void setup() {
	...
	public void shouldTestCreateUser() {
		...
		verify(userRepository).save(any(User.class)); // Verifying save method is called or not
